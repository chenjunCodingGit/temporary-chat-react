...
var Base = exports.Base = function Base(props) {
  ...
  return /*#__PURE__*/(0, _reactDom.createPortal)(/*#__PURE__*/_react.default.createElement("div", {
    ...
    id: titleId
  }, title), isPopup && subTitle && /*#__PURE__*/_react.default.createElement("h6", {
    className: "".concat(baseClass, "-subtitle")
  }, subTitle), showClose && onClose && /*#__PURE__*/_react.default.createElement(_IconButton.IconButton, {
