...
export type ComponentInterface = ComponentInterfaceWithComponent | ComponentInterfaceWithUrl | ComponentInterfaceWithDecorator;
...
export interface ComponentsContextInterface {
    ...
    getComponent: (code: string, callback?: GetComponentCallback) => React.ComponentType<any> | LazyComponentResult | null;
}
